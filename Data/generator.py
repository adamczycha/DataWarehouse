...
class Data(Faker):
    def __init__(self) -> None:
        ...
        self.Ticket_Number=             513501
        self.TicketResolution_Number=   513501
        self.Customer_Number=           10185
        self.Employees_Number=          1956


        self.Ticket_NumberT2=           551857
        self.TicketResolution_NumberT2= 551857
        self.Customer_NumberT2=         8154
        self.Employees_NumberT2=        1211
